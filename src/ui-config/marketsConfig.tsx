...
export enum CustomMarket {
  ...
  proto_ganache_v3 = 'proto_ganache_v3',
  // v3 mainnets
...
export const marketsData: {
  ...
  [CustomMarket.proto_arbitrum_sepolia_v3]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x282c43333e53E9Af27f12001775f6576DcFc9023',
      LENDING_POOL: '0xc8C0E14227Ed71c98d07F64B049B1609a4A778D7',
      WETH_GATEWAY: '0xB7eE2bab66F4eFf9Cd669DFE154cAd4669701EA2',
      FAUCET: '0xE65cA661AB0FdFB5215625AeD83c6B4Fd55D97B2',
      WALLET_BALANCE_PROVIDER: '0xC51506496712A98551673882D7a98D95Fde6e865',
      UI_POOL_DATA_PROVIDER: '0xe2a5ddd615d563af980D5DFc5c6716aF4486486A',
      UI_INCENTIVE_DATA_PROVIDER: '0x8265F7e04bc98E3F574d5Dc2Eb1FBE903c99351E',
      L2_ENCODER: '0xE9DA032F3A20512E90DDD6276A051e0c97AA339E',
  ...
  [CustomMarket.proto_ganache_v3]: {
    marketTitle: 'Ganache',
    market: CustomMarket.proto_ganache_v3,
    v3: true,
    permitDisabled: true,
    chainId: 1337 as any,
    enabledFeatures: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x0Eac02c069F7Db16C7c7d816c6476377749D47d2',
      LENDING_POOL: '0xe06886E189ccd901b57e05B95e62Dd83710685B6',
      WETH_GATEWAY: '0x60197EA115fCC83d7789075A844426cb870b5D3e',
      FAUCET: '0x2372D02dAD63eaD7125F454ed864914c232bF742',
      WALLET_BALANCE_PROVIDER: '0x26f552bF65014c8b22825EBFBc4e3527Eb83D4cE',
      UI_POOL_DATA_PROVIDER: '0x1bF275Ee69488CDA0D24cCaDcb48d8eA39810f64',
      UI_INCENTIVE_DATA_PROVIDER: '0x63aaCCBF7699774D7ff804939B5202025D37f588',
      L2_ENCODER: '0x32192fdC1EbBCf1acF7f3bea17BFd343a4ec0171'
    },
  },
} as const;
